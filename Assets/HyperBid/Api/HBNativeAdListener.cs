...
{
    public interface HBNativeAdListener
    {
		/***
		 ...
		 */ 
        void onAdImpressed(string placementId, HBCallbackInfo callbackInfo);
		/**
		 * 广告点击（注意：对于Android来说，所有回调方法均不在Unity的主线程）
		 */ 
        void onAdClicked(string placementId, HBCallbackInfo callbackInfo);
		/***
		 ...
		 */
        void onAdCloseButtonClicked(string placementId, HBCallbackInfo callbackInfo);
