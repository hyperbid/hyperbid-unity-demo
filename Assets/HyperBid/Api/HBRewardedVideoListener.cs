...
{
    public interface HBRewardedVideoListener
    {
		/***
		 ...
		 */ 
        void onRewardedVideoAdPlayStart(string placementId, HBCallbackInfo callbackInfo);
		/***
		 * 视频播放结束（注意：对于Android来说，所有回调方法均不在Unity的主线程）
		 */ 
        void onRewardedVideoAdPlayEnd(string placementId, HBCallbackInfo callbackInfo);
		/***
		 ...
		 */ 
        void onRewardedVideoAdPlayClosed(string placementId,bool isReward, HBCallbackInfo callbackInfo);
		/***
		 * 视频点击（注意：对于Android来说，所有回调方法均不在Unity的主线程）
		 */ 
        void onRewardedVideoAdPlayClicked(string placementId, HBCallbackInfo callbackInfo);
        /**
         * 激励下发（注意：对于Android来说，所有回调方法均不在Unity的主线程）
         */
        void onReward(string placementId, HBCallbackInfo callbackInfo);
